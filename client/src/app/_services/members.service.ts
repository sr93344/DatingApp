...
export class MembersService {
  ...
  getMembers(userParams: UserParams){
    ...
    let params = this._getPaginationHeaders(userParams.pageNumber, userParams.pageSize);

    params = params.append('minAge', userParams.minAge);
    params = params.append('maxAge', userParams.maxAge);
    params = params.append('gender', userParams.gender);
    params = params.append('orderBy', userParams.orderyBy);
    return this._getPaginatedResult<Member[]>(this.baseUrl+'users',params).pipe(
      map(response => {
  ...
  getLikes(predicate:string, pageNumber: number, pageSize: number){
    ...
    return this._getPaginatedResult<Member[]>(this.baseUrl+'likes', params);
  }
